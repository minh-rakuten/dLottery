      ...
      <Card sx={{ color: '#4B0082', marginTop: '40px', maxWidth: 600, margin: "0 auto", padding: '20px'}}>
        ...
        <CardContent sx={{padding: '40px'}}>
          <form onSubmit={handleSubmit}>
            ...
            <TextField label="Ticket Price" variant="outlined" type='number' fullWidth sx={{ color: '#4B0082', mb: 3, "& label.Mui-focused": { color: '#4B0082', borderColor: '#ffa000' } }} InputProps={{ endAdornment: 'ETH' }} InputLabelProps={{ "& .Mui-focused": { borderColor: '#ffa000' } }} />
            ...
            <TextField label="NFT Collection Address" type='text' variant="outlined" fullWidth sx={{ color: '#4B0082', mb: 3, "& label.Mui-focused": { color: '#4B0082', borderColor: '#ffa000' } }} InputProps={{ endAdornment: 'ETH' }} InputLabelProps={{ "& .Mui-focused": { borderColor: '#ffa000' } }} />
